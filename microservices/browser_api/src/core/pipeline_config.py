...
class PipelineConfig:
    ...
    # Processing options
    api_base_url: str = "https://gp2-browser-api-776926281950.europe-west1.run.app/" #"http://localhost:8000"
