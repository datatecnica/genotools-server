...
appservices:
  gp2browserApp:
    image: us-east1-docker.pkg.dev/gp2-code-test-env/gt-server/gp2-browser-app:COMMIT_SHA
  ...
  genotrackerApp:
    image: us-east1-docker.pkg.dev/gp2-code-test-env/gt-server/genotracker-app:COMMIT_SHA #us-east1-docker.pkg.dev/gp2-code-test-env/syed-test/genotools-server/apps/genotracker-app:latest
...
microservices:
  genotrackerApi:
    image: us-east1-docker.pkg.dev/gp2-code-test-env/gt-server/genotracker-api:COMMIT_SHA #us-east1-docker.pkg.dev/gp2-code-test-env/syed-test/genotools-server/microservices/genotracker-api:latest #us-east1-docker.pkg.dev/gp2-code-test-env/syed-test/genotools-server/api/genotracker-fastapi:latest
  ...
  genotoolsApi:
    image: us-east1-docker.pkg.dev/gp2-code-test-env/gt-server/genotools-api:COMMIT_SHA #us-east1-docker.pkg.dev/gp2-code-test-env/syed-test/genotools-server/microservices/genotools-api:latest
  ...
  gtPrecheckAPI:
    image: us-east1-docker.pkg.dev/gp2-code-test-env/gt-server/gtprecheck-api:COMMIT_SHA #us-east1-docker.pkg.dev/gp2-code-test-env/syed-test/genotools-server/microservices/gt_precheck:latest
