...
appservices:
  gp2browserApp:
    image: europe-west4-docker.pkg.dev/gp2-code-test-env/gt-server/gp2-browser-app:COMMIT_SHA
  ...
  genotrackerApp:
    image: europe-west4-docker.pkg.dev/gp2-code-test-env/gt-server/genotracker-app:COMMIT_SHA 
...
microservices:
  genotrackerApi:
    image: europe-west4-docker.pkg.dev/gp2-code-test-env/gt-server/genotracker-api:COMMIT_SHA 
  ...
  genotoolsApi:
    image: europe-west4-docker.pkg.dev/gp2-code-test-env/gt-server/genotools-api:COMMIT_SHA 
  ...
  gtPrecheckAPI:
    image: europe-west4-docker.pkg.dev/gp2-code-test-env/gt-server/gtprecheck-api:COMMIT_SHA 
