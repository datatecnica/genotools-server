...
class AppConfig(BaseSettings):
    ...
    # FRONTEND_BUCKET_NAME: str = "/app/data/gt_app_utils"
    # FRONTEND_BUCKET_NAME: str = "/app/data/apps-data/gt_app_utils"
    FRONTEND_BUCKET_NAME: str = "/app/data/cohort_browser/"
